...
def train():
    ...
    # Load CAUSAL graphs from Layer 3
    ...
    print(f"Loading causal training data from {train_path.name}")
    train_dataset = load_data(train_path)
    print(f"Loading causal validation data from {val_path.name}")
    ...
    model_save_path = config.MODELS_DIR / "best_causal_classical_gnn.pt"
    ...
    history_path = config.RESULTS_DIR / "causal_classical_gnn_training_history.json"
