...
def train():
    ...
    print(f"Loading FULL training data from {train_path.name}")
    train_dataset = load_data(train_path)
    print(f"Loading FULL validation data from {val_path.name}")
    ...
    model_save_path = config.MODELS_DIR / "best_full_qcgnn.pt"
    ...
    history_path = config.RESULTS_DIR / "full_qcgnn_training_history.json"
